...
var _tamagotchi = require("./Tamagotchi");
var _tamagotchiDefault = parcelHelpers.interopDefault(_tamagotchi);
(()=>{
    const pet = new _tamagotchiDefault.default();
    const populateStats = ()=>{
        ...
        const addPoop = ()=>{
            pet.PoopBool = false;
            const poopImage1 = document.querySelector('.poopimage');
            poopImage1.classList.toggle('hidden');
            const addOne = ()=>{
...
},{"./Tamagotchi":"ep3F1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ep3F1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Tamagotchi
);
class Tamagotchi {
    constructor(){
        this.happy = 5;
    ...
    feedPet() {
        ...
        if (this.lastFeed !== -1) {
            if (diff <= 10 && this.happy >= 0 && this.happy <= 10 && this.hungry < 10) {
                this.happy--;
                this.lastFeed = timer;
            }
        }
    ...
    playWithPet() {
        ...
        if (this.lastPlay !== -1) {
            if (diff <= 10 && this.hungry <= 10 && this.hungry >= 0 && this.happy <= 10) {
                this.hungry++;
                this.lastPlay = timer;
            }
        }
...
},{}]},["lpcHr","jeorp"], "jeorp", "parcelRequire5ce5")
